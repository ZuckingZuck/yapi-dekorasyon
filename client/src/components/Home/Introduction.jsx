    ...
    return (
        <div className='container mx-auto flex justify-center items-center mt-16 gap-10'>
            <div id='intro' className='flex flex-col gap-3 w-1/6'>
                <h1 className='text-blue-600 text-lg tracking-widest'>Hayal edin gerçekleştirelim!</h1>
                <p className='text-gray-600 tracking-widest'>Güvenilir Profesyonel Ekip</p>
                <p className='text-gray-500'>Yapı Dekorasyon olarak sayısız projeye attığımız imza ile kazanmış olduğumuz tecrübeyi inşaat, projelendirme, tadilat ve dekorasyon alanında sizlere ihtiyacınızı karşılayacak çözümler sunmaktayız</p>
                ...
                <NavLink onClick={scrollToTop} to="/projelerimiz" className="bg-blue-800 opacity-85 hover:opacity-100 duration-200 px-3 py-2 rounded text-white flex items-center justify-between">Projelerimiz <FontAwesomeIcon icon={faLayerGroup} /></NavLink>
            </div>
